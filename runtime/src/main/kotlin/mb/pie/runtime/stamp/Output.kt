package mb.pie.runtime.stamp

import mb.pie.runtime.Out
import mb.pie.runtime.impl.stamp.output.EqualsOutputStamper
import mb.pie.runtime.impl.stamp.output.InconsequentialOutputStamper
