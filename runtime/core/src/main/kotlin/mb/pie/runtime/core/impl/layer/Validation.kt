...
import mb.pie.runtime.core.impl.exec.hasCallReq
import java.io.*
import java.util.*
...
class ValidationLayer @Inject constructor(logger: Logger) : Layer {
  ...
  override fun <I : In, O : Out> validatePreWrite(app: FuncApp<I, O>, data: FuncAppData<O>, txn: StoreReadTxn) {
    for((path, _) in data.pathGens) {
      ...
      if(generator != null && generator != app) {
        // Overlapping generated file for `path`.
  ...
  override fun <I : In, O : Out> validatePostWrite(app: FuncApp<I, O>, data: FuncAppData<O>, txn: StoreReadTxn) {
    for((path, _) in data.pathReqs) {
      ...
      when {
        generator == null -> {
          // No generator for `path`.
        }
        app == generator -> {
          // Required `path` generated by itself (`app`).
        }
    ...
    for((path, _) in data.pathGens) {
      // 'path' is generated by 'result', and path is required by 'requiredBy', thus 'requiredBy' must (transitively) require 'app'.
