...
open internal class LMDBStoreReadTxn(
  ...
  override fun produces(app: UFuncApp): UExecRes? {
    ...
    if(valBytes != null) {
      ...
      logger.error("Cannot get produced value for {}, deserialization failed", app)
  ...
  override fun generatedBy(path: PPath): UFuncApp? {
    ...
    if(valBytes != null) {
      ...
      // Deserialization failed, remove entry
      logger.error("Cannot get generated by value for {}, deserialization failed", path)
  ...
  override fun requiredBy(path: PPath): UFuncApp? {
    ...
    if(valBytes != null) {
      ...
      // Deserialization failed, remove entry
      logger.error("Cannot get required by value for {}, deserialization failed", path)
