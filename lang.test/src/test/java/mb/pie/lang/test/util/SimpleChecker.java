...
public class SimpleChecker {
    public static <O extends Serializable> void assertTaskOutputEquals(TaskDefsModule taskDefsModule, Class<? extends TaskDef<None, O>> taskClass, O expectedOutput) throws Exception {
        assertTaskOutputEquals(taskDefsModule, taskClass, None.instance, expectedOutput);
    }

    private static <I extends Serializable, O extends Serializable> void assertTaskOutputEquals(TaskDefsModule taskDefsModule, Class<? extends TaskDef<I, O>> taskClass, I input, O expectedOutput) throws Exception {
